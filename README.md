...
I’ve always struggled with deciding where to go from my saved places on Google Maps, especially when choosing somewhere to eat. You can save tons of places, but Google Maps only lets you sort them by name or date added. There’s no real way to filter, interact with, or get recommendations from them. That frustration led to the idea for Map Whisperer.
